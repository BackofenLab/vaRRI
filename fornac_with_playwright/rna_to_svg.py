...
def run(structure, sequence, file_name, file_type, coloring_type="default"):
    try:
...
if __name__ == '__main__':
    ...
    run(args.structure, args.sequence, output_file_name, output_file_type, args.coloring_mode)